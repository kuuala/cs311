...
namespace SimpleLang.Visitors
{
    public class GenCodeVisitor: Visitor
    {
        ...
        {
            Label startWhile = genc.DefineLabel();
            Label endWhile = genc.DefineLabel();
            genc.MarkLabel(startWhile);
            w.Expr.Visit(this);
            genc.Emit(OpCodes.Brfalse, endWhile);
            w.Stat.Visit(this);
            genc.Emit(OpCodes.Br, startWhile);
        ...
        {
            Label stateFalse = genc.DefineLabel();
            cond.Expr.Visit(this);
            genc.Emit(OpCodes.Brfalse, stateFalse);
            cond.StateTrue.Visit(this);
            genc.MarkLabel(stateFalse);
            cond.StateFalse?.Visit(this);
        }
